                                    ...
                                    <div class="col-sm-11">
                                        ...
                                        <p>
                                            ...
                                            <?php if (extension_loaded('mbstring')): ?>
                                                <strong class="color-success">Enabled</strong>
                                            <?php else: ?>
                                                <strong class="color-danger">Disabled&nbsp;<small>(You should enable "mbstring" PHP extension in your server)</small>
                                                </strong>
                                            <?php endif; ?>
                                        </p>
                                        <p>
                                            ...
                                            <?php if (extension_loaded('gd')): ?>
                                                <strong class="color-success">Enabled</strong>
                                            <?php else: ?>
                                                <strong class="color-danger">Disabled&nbsp;<small>(You should enable "gd" PHP extension in your server)</small>
                                                </strong>
                                            <?php endif; ?>
                                        </p>
